            ...
            <div class="row">
                <div class="col-lg-12 mt-1 mr-1">
                    <div class="float-right">
                        <a class="btn btn-success" href="{{ route('editor.articles.create') }}">Create New Article</a>
                    </div>
                </div>
            </div>
            @endcannot
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('editor.articles.destroy',$article->id) }}" method="POST">
                                    ...
                                    <a class="btn btn-info" href="{{ route('editor.articles.show',$article->id) }}">Show</a>
                    
                                    <a class="btn btn-primary" href="{{ route('editor.articles.edit',$article->id) }}">Edit</a>
